...
mod VesuRebalance {
    ...
    use stackbits_contract_v1::interfaces::IERC4626::{
    ...
    use stackbits_contract_v1::components::erc4626::{ERC4626Component};
    ...
    use stackbits_contract_v1::strategies::vesu_rebalance::interface::{
        IVesuMigrate, IVesuTokenV2Dispatcher, IVesuTokenV2DispatcherTrait
    };
    ...
    impl ExternalImpl of IVesuRebal<ContractState> {
        ...
        // harvest() function removed - not needed for stablecoin pools
