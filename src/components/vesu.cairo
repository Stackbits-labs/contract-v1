...
use stackbits_contract_v1::interfaces::IVesu::{
    IVesu, Amount, ModifyPositionParams, AmountType, AmountDenomination
};
use stackbits_contract_v1::interfaces::IVesu::{IStonDispatcher, IStonDispatcherTrait};
use stackbits_contract_v1::interfaces::oracle::{IPriceOracleDispatcher, IPriceOracleDispatcherTrait};
use stackbits_contract_v1::interfaces::lendcomp::ILendMod;
use stackbits_contract_v1::helpers::ERC20Helper;
use core::num::traits::Zero;
use alexandria_math::i257::{I257Trait};
use stackbits_contract_v1::helpers::pow;
...
pub impl vesuSettingsImpl of ILendMod<vesuStruct, vesuToken> {
    ...
    fn borrow_amount(self: @vesuStruct, token: ContractAddress, user: ContractAddress) -> u256 {
        let stonDisp = *self.singleton;
...
mod tests {
    use stackbits_contract_v1::interfaces::lendcomp::ILendMod;
    use stackbits_contract_v1::helpers::constants;
    use super::{vesuStruct, vesuToken};
    use stackbits_contract_v1::interfaces::IVesu::{IStonDispatcher};
